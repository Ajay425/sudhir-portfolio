...
export const Contact = () => {
    ...
    const handleSubmit = (e) => {
        e.preventDefault();
        const mailtoLink = `mailto:sudhirbairavaa59534@gmail.com?subject=Portfolio Contact from ${encodeURIComponent(formData.name)}&body=${encodeURIComponent(formData.message)}%0A%0AFrom: ${encodeURIComponent(formData.name)} (${encodeURIComponent(formData.email)})`;
                ...
                <div className="flex flex-col gap-6 max-w-sm">
                    ...
                    <div className="flex flex-col gap-4">
                        ...
                        <div className="flex items-center gap-3">
                            ...
                            <a href="tel:+919876543210" className="text-white/80 hover:text-[#c49260] transition-colors">+91 8217623370</a>
                        </div>
                    </div>

                    {/* Social Links */}
                    <div className="flex gap-4 mt-2">
                        <a href="https://www.instagram.com/sudhir_r__?igsh=MWIycnp0NGNocjQ0&utm_source=qr" target="_blank" rel="noopener noreferrer" className="text-white/60 hover:text-[#c49260] transition-colors">
                        ...
                        <a href="https://linkedin.com/in/sudhir-r24" target="_blank" rel="noopener noreferrer" className="text-white/60 hover:text-[#c49260] transition-colors">
